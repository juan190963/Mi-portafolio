    ...
    return (
        <div className="z-20 w-full bg-darkBg/60">
            <div className="z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2">
                <Image src="/home-4.png" priority width="600" height="400" alt="Avatar" className="pt-20"/>
                <div className="flex flex-col justify-center max-w-md">
                    ...
                    <p className="mx-auto mb-2 text-xl md:text-xl md:mx-0 md:mb-16">
                    ...
                    <div className="flex items-center justify-center gap-3 md:justify-start md:gap-10">
                        ...
                        <a href="https://wa.me/3125191306"
                            className="px-3 py-2 my-5 transition-all border-2 cursor-pointer text-md w-fit text-green-200 border-green-500 rounded-xl hover:shadow-xl hover:shadow-green-500" >
                            Contacta conmigo
                        </a>
                    </div>
                </div>
